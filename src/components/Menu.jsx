...
function Menu(){
  ...
  return (
    <>
      {/* Desktop Menu */}
      <div className="hidden lg:flex items-center justify-between bg-blue-800/10 border border-blue-500/10 p-6">
      ...
      {/* Mobile Header */}
      <div className="lg:hidden backdrop-blur-md bg-white/5 shadow-lg p-4 border-b border-white/10 flex justify-end">
        <button
            ...
            <nav className="px-6 mt-8">
              ...
              <div className="mt-12">
                <a
                  ...
                  download="Curriculo.pdf"
                  onClick={() => setIsOpen(false)}
                  className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm uppercase font-semibold rounded-lg hover:shadow-lg transition-all duration-300"
                  style={{
